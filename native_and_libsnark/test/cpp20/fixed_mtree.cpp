...
static bool run_tests()
{
    ...
    auto digest256 = HEXARRAY(26b0052694fc42fdff93e6fb5a71d38c3dd7dc5b6ad710eb048c660233137fab);
    auto digest512 =
        HEXARRAY(6e3d539e81fcba88a5a6875590df1f6ec06e67b1656504bd60f33953b81b080637d790e65789a4e03bfa4d457cb820f5153a0299c74798775d4295e9b0955517);
    ...
    check = true;
    {
        ...
        FixedMTree<HEIGHT, Sha256> tree(data.begin(), data.end());

        check = memcmp(tree.digest().data(), digest256.data(), digest256.size()) == 0;
    }
    std::cout << check << '\n';
    all_check &= check;
    ...
    check = true;
    {
        ...
        FixedMTree<HEIGHT, Sha512> tree(data.begin(), data.end());

        check = tree.digest() == digest512;
    }
    std::cout << check << '\n';
    all_check &= check;
    ...
    check = true;
    {
        ...
        FixedMTreePath<HEIGHT, Sha256> tree(data.begin(), data.end());

        check = tree.digest() == digest256;
    }
    std::cout << check << '\n';
    all_check &= check;
    ...
    check = true;
    {
        ...
        FixedMTreePath<HEIGHT, Sha512> tree(data.begin(), data.end());
