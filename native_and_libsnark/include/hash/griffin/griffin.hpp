...
template<typename FieldT = libff::Fr<libff::default_ec_pp>, size_t rate = 2, size_t capacity = 1, size_t rounds = 12>
class Griffin
{
public:
    using Field = FieldT;
    ...
    static inline const Field e{modular_inverse(d, Field{-1})};
